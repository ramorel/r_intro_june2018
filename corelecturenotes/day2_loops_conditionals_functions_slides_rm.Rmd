...
- The dataset has 142 countries 5 continents represented over 12 years
...
- `for` loops repeat a function for all values in a vector vector -- _don't cut and paste!_
...
## What is the average life expectancy by year?
...
for (i in years) {
  print(paste(i, ":", 
               mean(gapminder$lifeExp[gapminder$year == i], na.rm = T)))
}
```
...
for (i in conts) {
  print(paste(i, ":",
              mean(gapminder$lifeExp[gapminder$continent == i], na.rm = T)))
}
```
